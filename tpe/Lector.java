    ...
    public static List<Camion> getCamiones(String ruta) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(ruta))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                boolean refrigerado = Integer.parseInt(campos.get(2).trim()) == 1;
    ...
    public static List<Paquete> getPaquetes(String ruta) throws IOException {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(ruta))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                boolean contieneAlimentos = Integer.parseInt(campos.get(3).trim()) == 1;
                int nivelUrgencia = Integer.parseInt(campos.get(4).trim());

                paquetes.add(new Paquete(idPaq, codigo, pesoPaquete, contieneAlimentos, nivelUrgencia));
            }
        }
        return paquetes;
    }
